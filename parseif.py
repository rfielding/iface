...
class IfParser:
    ...
    def interfaceRenderFile(self, f):
        ...
        f.write("}\n")
        f.write("\n")
        f.write("/* Get a cooperating set of APIs */\n")
        f.write("public interface ApiSet {\n")
        f.write("    Api[] getApis();\n")
        f.write("}\n")
        f.write("\n")
        ...
        f.write("\n")
        f.write("    /* Untyped msging API*/\n")
        f.write("    Object doRcv(String msg, Object[] args);\n")
        f.write("    boolean doRcv_Precondition(String msg, Object[] args);\n")
        f.write("    Object doSend(Api a, String msg, Object[] args);\n")
        f.write("    String[] messageNames();\n")
        f.write("    String[] messageArgTypes(String msg);\n")
        f.write("    String messageArgReturnType(String msg);\n")
        f.write("\n")
        f.write("    interface Listener {\n")
        f.write("        void enter(String name);\n")
        f.write("        void send(String name, String exiting, String entering,\n")
        f.write("                       Api target, String msg, Object[] args\n")
        f.write("        );\n")
        f.write("        void sendReturned(String name, String exiting, String entering,\n")
        f.write("                               Api target, String msg, Object[] args, Object ret\n")
        f.write("        );\n")
        f.write("        void rcv(String name, String exiting, String entering,\n")
        f.write("                      String msg, Object[] args\n")
        f.write("        );\n")
        f.write("        void rcvReturn(String name, String exiting, String entering,\n")
        f.write("                            String msg, Object[] args,Object arg\n")
        f.write("        );\n")
        f.write("        void exit(String name);\n")
        f.write("    }\n")
        f.write("}\n")
        for mKey in self.modules:
            m = self.modules[mKey]
